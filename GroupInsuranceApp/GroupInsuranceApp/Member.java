...
public class Member implements Serializable {
	...
	/**********************************************************/
	/**
	 * toStringWithTab will format a String expression
	 * for writing to a file
	 * 
	 * @return String expression with tabs
	 */
	...
	/**********************************************************/
	/**
	 * A toString for printing to string.  Make it look neat.
	 * 
	...
	/**********************************************************/
	/**
	 * getFamilyScore calculates a score based on the member's
	 * family history
	 * 
	 * @return family history score
	 */
	...
	/**********************************************************/
	/** 
	 * getBloodPressure calculates a score based on the member's
	 * blood pressure
	 * 
	...
	/**********************************************************/
	/** 
	 * getBMI calculates a score based on the member's 
	 * Body Mass Index (BMI)
	 * 
	 * @return BMI score
	 */
	...
	// Getters and Setters get their own little section//
	...
	/**********************************************************/
	/**
	 * makeMember handles getting the member information from
	 * a new member
	 * 
	 * @param sc
	 * @return a new member
